...
**Объясняю JSON. Если хотите, можете попробовать сами использовать JSON и APIView. 
...
И я также развернул его на PythonAnywhere. Вы можете пойти и использовать его. 
Но перед этим свяжитесь со мной, чтобы я мог добавить ваш номер телефона в Twilio. 
...
2. Создайте виртуальное окружение Django и установите необходимые зависимости.
...
или свяжитесь со мной, чтобы я добавил ваш номер телефона в свою учетную запись twilio)
